...
// Pano2VR 6.0.1/17227
// Filename: simplex_v6_v2.ggsk
// Generated Sal Oca 31 21:50:26 2023
...
function pano2vrSkin(player, base) {
	...
	this.addSkin = function () {
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;show_controller_button;'
		);
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;show_controller_button;'
		);
		...
		me._hide_timer.ggDeactivate = function () {
			...
			me._show_controller_button.style.visibility = me._show_controller_button.ggVisible
				? 'inherit'
				: 'hidden';
			if (player.transitionsDisabled) {
				me._controller.style[domTransition] = 'none';
		...
		me._tt_show_controller.logicBlock_visible = function () {
			...
			if (me.elementMouseOver['show_controller_button'] == true) {
			...
			if (me._tt_show_controller.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_show_controller.ggCurrentLogicStateVisible == 0) {
					me._tt_show_controller.style.visibility =
						Number(me._tt_show_controller.style.opacity) > 0 ||
						!me._tt_show_controller.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_multires;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._loading_multires.logicBlock_visible = function () {
			...
			if (me._loading_multires.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._loading_multires.ggCurrentLogicStateVisible == 0) {
					me._loading_multires.style.visibility =
						Number(me._loading_multires.style.opacity) > 0 ||
						!me._loading_multires.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._screentint.logicBlock_alpha = function () {
			...
			if (me._screentint.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._screentint.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._screentint.ggCurrentLogicStateAlpha == 0) {
					me._screentint.style.visibility = me._screentint.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me._controller.logicBlock_position = function () {
			...
			if (me._controller.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._controller.style[domTransition] =
					'left 0s, bottom 0s, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
		...
		me._controller.logicBlock_alpha = function () {
			var newLogicStateAlpha;
			if (player.getVariableValue('vis_timer') == true) {
				newLogicStateAlpha = 0;
			} else {
				newLogicStateAlpha = -1;
			}
		...
		me._controller_slider.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_controller') == 1) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_controller') == 2) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_controller') == 3) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_controller') == 4) {
				newLogicStatePosition = 3;
			} else if (player.getVariableValue('pos_controller') == 5) {
				newLogicStatePosition = 4;
			} else if (player.getVariableValue('pos_controller') == 6) {
				newLogicStatePosition = 5;
			} else if (player.getVariableValue('pos_controller') == 7) {
				newLogicStatePosition = 6;
			} else if (player.getVariableValue('pos_controller') == 8) {
		...
		me._fullscreen_buttons.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_fullscreen') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_fullscreen') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_fullscreen') == 2) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_fullscreen') == 3) {
				newLogicStatePosition = 3;
			} else if (player.getVariableValue('pos_fullscreen') == 4) {
				newLogicStatePosition = 4;
			} else if (player.getVariableValue('pos_fullscreen') == 5) {
				newLogicStatePosition = 5;
			} else if (player.getVariableValue('pos_fullscreen') == 6) {
				newLogicStatePosition = 6;
			} else if (player.getVariableValue('pos_fullscreen') == 7) {
				newLogicStatePosition = 7;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._fullscreen_buttons.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_fullscreen') == true && player.getOS() != 4) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._fullscreen_buttons.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._fullscreen_buttons.ggCurrentLogicStateVisible == 0) {
					me._fullscreen_buttons.style.visibility =
						Number(me._fullscreen_buttons.style.opacity) > 0 ||
						!me._fullscreen_buttons.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;fullscreen;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;fullscreen;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;fullscreen_off;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;fullscreen_off;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._fullscreen_off.logicBlock_alpha = function () {
			...
			if (me._fullscreen_off.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._fullscreen_off.ggCurrentLogicStateAlpha == 0) {
					me._fullscreen_off.style.visibility = me._fullscreen_off.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me._tt_fullscreen.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['fullscreen_buttons'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_fullscreen.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_fullscreen.ggCurrentLogicStateVisible == 0) {
					me._tt_fullscreen.style.visibility =
						Number(me._tt_fullscreen.style.opacity) > 0 ||
						!me._tt_fullscreen.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_fullscreen.logicBlock_text = function () {
			...
			if (player.getIsFullscreen() == true) {
				newLogicStateText = 0;
			} else if (player.getIsFullscreen() == false) {
				newLogicStateText = 1;
			} else {
				newLogicStateText = -1;
			}
			if (me._tt_fullscreen.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._tt_fullscreen.ggCurrentLogicStateText == 0) {
					...
					if (me._tt_fullscreen.ggUpdateText) {
						...
						if (me._tt_fullscreen.ggUpdatePosition)
							me._tt_fullscreen.ggUpdatePosition();
					}
		...
		me._gyro.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_gyro') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_gyro') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_gyro') == 2) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_gyro') == 3) {
				newLogicStatePosition = 3;
			} else if (player.getVariableValue('pos_gyro') == 4) {
				newLogicStatePosition = 4;
			} else if (player.getVariableValue('pos_gyro') == 5) {
				newLogicStatePosition = 5;
			} else if (player.getVariableValue('pos_gyro') == 6) {
				newLogicStatePosition = 6;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._gyro.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_gyro') == true && player.getIsMobile() == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;gyro_on;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;gyro_on;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;gyro_off;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;gyro_off;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_gyro.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['gyro'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_gyro.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_gyro.ggCurrentLogicStateVisible == 0) {
					me._tt_gyro.style.visibility =
						Number(me._tt_gyro.style.opacity) > 0 || !me._tt_gyro.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_gyro.logicBlock_text = function () {
			...
			if (player.getUseGyro() == true) {
				newLogicStateText = 0;
			} else if (player.getUseGyro() == false) {
				newLogicStateText = 1;
			} else {
				newLogicStateText = -1;
			}
		...
		me._projection_buttons.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_projection') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_projection') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_projection') == 2) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_projection') == 3) {
				newLogicStatePosition = 3;
			} else if (player.getVariableValue('pos_projection') == 4) {
				newLogicStatePosition = 4;
			} else if (player.getVariableValue('pos_projection') == 5) {
				newLogicStatePosition = 5;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._projection_buttons.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_projection') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._projection_buttons.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._projection_buttons.ggCurrentLogicStateVisible == 0) {
					me._projection_buttons.style.visibility =
						Number(me._projection_buttons.style.opacity) > 0 ||
						!me._projection_buttons.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._projection_buttons.onclick = function (e) {
			if (player.getProjection() == 4) {
				player.changeProjectionEx(9, 1);
			}
			if (player.getProjection() == 9) {
				player.changeProjectionEx(12, 1);
			}
			if (player.getProjection() == 12) {
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;stereographic;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;stereographic;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_projection.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['projection_buttons'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_projection.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_projection.ggCurrentLogicStateVisible == 0) {
					me._tt_projection.style.visibility =
						Number(me._tt_projection.style.opacity) > 0 ||
						!me._tt_projection.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_projection.logicBlock_text = function () {
			...
			if (player.getProjection() == 4) {
				newLogicStateText = 0;
			} else if (player.getProjection() == 9) {
				newLogicStateText = 1;
			} else if (player.getProjection() == 12) {
				newLogicStateText = 2;
			} else {
				newLogicStateText = -1;
			}
			if (me._tt_projection.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._tt_projection.ggCurrentLogicStateText == 0) {
					...
					if (me._tt_projection.ggUpdateText) {
						...
						if (me._tt_projection.ggUpdatePosition)
							me._tt_projection.ggUpdatePosition();
					}
		...
		me._thumbnail.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_thumbnail') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_thumbnail') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_thumbnail') == 2) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_thumbnail') == 3) {
				newLogicStatePosition = 3;
			} else if (player.getVariableValue('pos_thumbnail') == 4) {
				newLogicStatePosition = 4;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._thumbnail.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_thumbnail') == true && player.getIsTour() == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._thumbnail.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._thumbnail.ggCurrentLogicStateVisible == 0) {
					me._thumbnail.style.visibility =
						Number(me._thumbnail.style.opacity) > 0 || !me._thumbnail.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._thumbnail.onclick = function (e) {
			if (player.getViewerSize().width <= 450) {
				player.setVariableValue(
					'vis_thumbnail_menu_mobile',
					!player.getVariableValue('vis_thumbnail_menu_mobile')
				);
			}
			if (player.getViewerSize().width > 450) {
				player.setVariableValue(
					'vis_thumbnail_menu_show',
					!player.getVariableValue('vis_thumbnail_menu_show')
				);
			}
		};
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;thumbnail_show_button_show;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;thumbnail_show_button_show;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_thumbnail_open.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['thumbnail'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_thumbnail_open.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_thumbnail_open.ggCurrentLogicStateVisible == 0) {
					me._tt_thumbnail_open.style.visibility =
						Number(me._tt_thumbnail_open.style.opacity) > 0 ||
						!me._tt_thumbnail_open.style.opacity
							? 'inherit'
							: 'hidden';
			...
			if (me._tt_thumbnail_open.ggCurrentLogicStateText != newLogicStateText) {
				...
				if (me._tt_thumbnail_open.ggCurrentLogicStateText == 0) {
					...
					if (me._tt_thumbnail_open.ggUpdateText) {
						...
						if (me._tt_thumbnail_open.ggUpdatePosition)
							me._tt_thumbnail_open.ggUpdatePosition();
					}
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;info;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;info;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._info.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_information') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_information') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_information') == 2) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_information') == 3) {
				newLogicStatePosition = 3;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._info.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_info') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._info.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._info.ggCurrentLogicStateVisible == 0) {
					me._info.style.visibility =
						Number(me._info.style.opacity) > 0 || !me._info.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_userdata.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['info'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_userdata.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_userdata.ggCurrentLogicStateVisible == 0) {
					me._tt_userdata.style.visibility =
						Number(me._tt_userdata.style.opacity) > 0 || !me._tt_userdata.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._autorotate_buttons.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_autorotate') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_autorotate') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_autorotate') == 2) {
				newLogicStatePosition = 2;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._autorotate_buttons.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_autorotate') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._autorotate_buttons.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._autorotate_buttons.ggCurrentLogicStateVisible == 0) {
					me._autorotate_buttons.style.visibility =
						Number(me._autorotate_buttons.style.opacity) > 0 ||
						!me._autorotate_buttons.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;autorotate_start;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;autorotate_start;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._autorotate_start.logicBlock_alpha = function () {
			...
			if (me._autorotate_start.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._autorotate_start.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._autorotate_start.ggCurrentLogicStateAlpha == 0) {
					me._autorotate_start.style.visibility = 'hidden';
					me._autorotate_start.style.opacity = 0;
				} else {
					me._autorotate_start.style.visibility = me._autorotate_start.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;autorotate_stop;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;autorotate_stop;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._autorotate_stop.logicBlock_alpha = function () {
			...
			if (me._autorotate_stop.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._autorotate_stop.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._autorotate_stop.ggCurrentLogicStateAlpha == 0) {
					me._autorotate_stop.style.visibility = me._autorotate_stop.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me._tt_rotate.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['autorotate_buttons'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_rotate.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_rotate.ggCurrentLogicStateVisible == 0) {
					me._tt_rotate.style.visibility =
						Number(me._tt_rotate.style.opacity) > 0 || !me._tt_rotate.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_rotate.logicBlock_text = function () {
			...
			if (player.getIsAutorotating() == true) {
				newLogicStateText = 0;
			} else if (player.getIsAutorotating() == false) {
				newLogicStateText = 1;
			} else {
				newLogicStateText = -1;
			}
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;zoomout;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;zoomout;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._zoomout.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_zoom') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._zoomout.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._zoomout.ggCurrentLogicStateVisible == 0) {
					me._zoomout.style.visibility =
						Number(me._zoomout.style.opacity) > 0 || !me._zoomout.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_zoomout.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['zoomout'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_zoomout.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_zoomout.ggCurrentLogicStateVisible == 0) {
					me._tt_zoomout.style.visibility =
						Number(me._tt_zoomout.style.opacity) > 0 || !me._tt_zoomout.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;zoomin;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;zoomin;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._zoomin.logicBlock_visible = function () {
			...
			if (me._zoomin.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._zoomin.ggCurrentLogicStateVisible == 0) {
					me._zoomin.style.visibility =
						Number(me._zoomin.style.opacity) > 0 || !me._zoomin.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_zoomin.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['zoomin'] == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_zoomin.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_zoomin.ggCurrentLogicStateVisible == 0) {
					me._tt_zoomin.style.visibility =
						Number(me._tt_zoomin.style.opacity) > 0 || !me._tt_zoomin.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._element_alpha_timer.ggIsActive = function () {
			return (
				me._element_alpha_timer.ggTimestamp + me._element_alpha_timer.ggTimeout >=
				me.ggCurrentTime
			);
		};
		el.ggElementNodeId = function () {
		...
		me._thumbnail_menu.ggScrollByX = function (diffX) {
			...
			me._thumbnail_menu.ggScrollPosX = Math.min(
				me._thumbnail_menu.ggScrollPosX,
				me._thumbnail_menu__horScrollBg.clientWidth -
					me._thumbnail_menu__horScrollFg.clientWidth
			);
			me._thumbnail_menu__horScrollFg.style.left = me._thumbnail_menu.ggScrollPosX + 'px';
			me._thumbnail_menu__content.style.left =
				-Math.round(
					me._thumbnail_menu.ggScrollPosX / me._thumbnail_menu.ggHPercentVisible
				) +
				me._thumbnail_menu.ggContentLeftOffset +
				'px';
			me._thumbnail_menu.ggScrollPosXPercent =
				me._thumbnail_menu__horScrollFg.offsetLeft /
				me._thumbnail_menu__horScrollBg.clientWidth;
		};
		...
		me._thumbnail_menu.ggScrollByY = function (diffY) {
			...
			me._thumbnail_menu.ggScrollPosY = Math.min(
				me._thumbnail_menu.ggScrollPosY,
				me._thumbnail_menu__vertScrollBg.clientHeight -
					me._thumbnail_menu__vertScrollFg.clientHeight
			);
			me._thumbnail_menu__vertScrollFg.style.top = me._thumbnail_menu.ggScrollPosY + 'px';
			me._thumbnail_menu__content.style.top =
				-Math.round(
					me._thumbnail_menu.ggScrollPosY / me._thumbnail_menu.ggVPercentVisible
				) +
				me._thumbnail_menu.ggContentTopOffset +
				'px';
			me._thumbnail_menu.ggScrollPosYPercent =
				me._thumbnail_menu__vertScrollFg.offsetTop /
				me._thumbnail_menu__vertScrollBg.clientHeight;
		};
		...
		me._thumbnail_menu.ggScrollIntoView = function (posX, posY, width, height) {
			if (me._thumbnail_menu.ggHorScrollVisible) {
				if (posX < 0) {
					...
					posX + width >
					me._thumbnail_menu.clientWidth -
						(me._thumbnail_menu.ggVertScrollVisible ? 15 : 0)
				) {
					var diffX = Math.ceil(
						(posX +
							width -
							(me._thumbnail_menu.clientWidth -
								(me._thumbnail_menu.ggVertScrollVisible ? 15 : 0))) *
							me._thumbnail_menu.ggHPercentVisible
					);
					me._thumbnail_menu.ggScrollByXSmooth(diffX);
				}
			}
			if (me._thumbnail_menu.ggVertScrollVisible) {
				if (posY < 0) {
					...
					posY + height >
					me._thumbnail_menu.clientHeight -
						(me._thumbnail_menu.ggHorScrollVisible ? 15 : 0)
				) {
					var diffY = Math.ceil(
						(posY +
							height -
							(me._thumbnail_menu.clientHeight -
								(me._thumbnail_menu.ggHorScrollVisible ? 15 : 0))) *
							me._thumbnail_menu.ggVPercentVisible
					);
					me._thumbnail_menu.ggScrollByYSmooth(diffY);
				}
			}
		...
		elHorScrollBg.setAttribute(
			'style',
			'position: absolute; left: 0px; bottom: 0px; visibility: hidden; width: 400px; height: 15px; background-color: rgba(255,255,255,0.392157); pointer-events: auto;'
		);
		...
		elHorScrollFg.setAttribute(
			'style',
			'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 400px; height: 15px; background-color: rgba(255,255,255,1); pointer-events: auto;'
		);
		...
		elCornerBg.setAttribute(
			'style',
			'position: absolute; right: 0px; bottom: 0px; visibility: hidden; width: 15px; height: 15px; background-color: rgba(255,255,255,1);'
		);
		...
		me._thumbnail_menu.logicBlock_position = function () {
			...
			if (
				...
				newLogicStatePosition = 0;
			} else if (player.getIsMobile() == true) {
				newLogicStatePosition = 1;
			} else {
				newLogicStatePosition = -1;
			}
		...
		me._thumbnail_menu.logicBlock_visible = function () {
			...
			if (me._thumbnail_menu.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._thumbnail_menu.ggCurrentLogicStateVisible == 0) {
					me._thumbnail_menu.style.visibility =
						Number(me._thumbnail_menu.style.opacity) > 0 ||
						!me._thumbnail_menu.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._thumbnail_menu.logicBlock_alpha = function () {
			...
			if (me._thumbnail_menu.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._thumbnail_menu.ggCurrentLogicStateAlpha == 0) {
					me._thumbnail_menu.style.visibility = me._thumbnail_menu.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me._thumbnail_menu.ggUpdatePosition = function (useTransition) {
			...
			}
			{
				...
				if (me._thumbnail_menu.ggHorScrollVisible) {
					...
					me._thumbnail_menu__horScrollBg.style.width =
						me._thumbnail_menu.ggAvailableWidth + 'px';
					me._thumbnail_menu.ggHPercentVisible =
						me._thumbnail_menu.ggAvailableWidth / contentWidth;
					if (me._thumbnail_menu.ggHPercentVisible > 1.0)
						me._thumbnail_menu.ggHPercentVisible = 1.0;
					me._thumbnail_menu.ggScrollWidth = Math.round(
						me._thumbnail_menu__horScrollBg.clientWidth *
							me._thumbnail_menu.ggHPercentVisible
					);
					me._thumbnail_menu__horScrollFg.style.width =
						me._thumbnail_menu.ggScrollWidth + 'px';
					me._thumbnail_menu.ggScrollPosX =
						me._thumbnail_menu.ggScrollPosXPercent *
						me._thumbnail_menu.ggAvailableWidth;
					me._thumbnail_menu.ggScrollPosX = Math.min(
						me._thumbnail_menu.ggScrollPosX,
						me._thumbnail_menu__horScrollBg.clientWidth -
							me._thumbnail_menu__horScrollFg.clientWidth
					);
					me._thumbnail_menu__horScrollFg.style.left =
						me._thumbnail_menu.ggScrollPosX + 'px';
					me._thumbnail_menu__content.style.left =
						-Math.round(
							me._thumbnail_menu.ggScrollPosX / me._thumbnail_menu.ggHPercentVisible
						) +
						this.ggContentLeftOffset +
						'px';
				} else {
					me._thumbnail_menu.ggScrollPosX = 0;
					me._thumbnail_menu.ggScrollPosXPercent = 0.0;
		...
		me._thumbnail_cloner.callChildLogicBlocks_changenodeid = function () {
			if (me._thumbnail_cloner.ggInstances) {
				...
				for (i = 0; i < me._thumbnail_cloner.ggInstances.length; i++) {
					if (
						me._thumbnail_cloner.ggInstances[i]._checkmark_tick &&
		...
		me._thumbnail_cloner.callChildLogicBlocks_mouseover = function () {
			if (me._thumbnail_cloner.ggInstances) {
				...
				for (i = 0; i < me._thumbnail_cloner.ggInstances.length; i++) {
					if (
						me._thumbnail_cloner.ggInstances[i]._thumbnail_active &&
						me._thumbnail_cloner.ggInstances[i]._thumbnail_active.logicBlock_bordercolor
					) {
						me._thumbnail_cloner.ggInstances[
							i
						]._thumbnail_active.logicBlock_bordercolor();
					}
				}
			}
		};
		...
		me._thumbnail_cloner.ggUpdatePosition = function (useTransition) {
			...
			if (
				!me._thumbnail_cloner.ggLastSize ||
				me._thumbnail_cloner.ggLastSize.w != w ||
				me._thumbnail_cloner.ggLastSize.h != h
			) {
		...
		me._thumbnail_menu_mobile.ggScrollByX = function (diffX) {
			...
			me._thumbnail_menu_mobile.ggScrollPosX =
				me._thumbnail_menu_mobile__horScrollFg.offsetLeft + diffX;
			me._thumbnail_menu_mobile.ggScrollPosX = Math.max(
				me._thumbnail_menu_mobile.ggScrollPosX,
				0
			);
			me._thumbnail_menu_mobile.ggScrollPosX = Math.min(
				me._thumbnail_menu_mobile.ggScrollPosX,
				me._thumbnail_menu_mobile__horScrollBg.clientWidth -
					me._thumbnail_menu_mobile__horScrollFg.clientWidth
			);
			me._thumbnail_menu_mobile__horScrollFg.style.left =
				me._thumbnail_menu_mobile.ggScrollPosX + 'px';
			me._thumbnail_menu_mobile__content.style.left =
				-Math.round(
					me._thumbnail_menu_mobile.ggScrollPosX /
						me._thumbnail_menu_mobile.ggHPercentVisible
				) +
				me._thumbnail_menu_mobile.ggContentLeftOffset +
				'px';
			me._thumbnail_menu_mobile.ggScrollPosXPercent =
				me._thumbnail_menu_mobile__horScrollFg.offsetLeft /
				me._thumbnail_menu_mobile__horScrollBg.clientWidth;
		};
		me._thumbnail_menu_mobile.ggScrollByXSmooth = function (diffX) {
			...
			var id = setInterval(function () {
				...
				if (
					diffX < 0 &&
					(scrollCurrX <= diffX || me._thumbnail_menu_mobile.ggScrollPosX <= 0)
				) {
					me._thumbnail_menu_mobile.ggScrollPosX = Math.max(
						me._thumbnail_menu_mobile.ggScrollPosX,
						0
		...
		me._thumbnail_menu_mobile.ggScrollByY = function (diffY) {
			...
			me._thumbnail_menu_mobile.ggScrollPosY =
				me._thumbnail_menu_mobile__vertScrollFg.offsetTop + diffY;
			me._thumbnail_menu_mobile.ggScrollPosY = Math.max(
				me._thumbnail_menu_mobile.ggScrollPosY,
				0
			);
			me._thumbnail_menu_mobile.ggScrollPosY = Math.min(
				me._thumbnail_menu_mobile.ggScrollPosY,
				me._thumbnail_menu_mobile__vertScrollBg.clientHeight -
					me._thumbnail_menu_mobile__vertScrollFg.clientHeight
			);
			me._thumbnail_menu_mobile__vertScrollFg.style.top =
				me._thumbnail_menu_mobile.ggScrollPosY + 'px';
			me._thumbnail_menu_mobile__content.style.top =
				-Math.round(
					me._thumbnail_menu_mobile.ggScrollPosY /
						me._thumbnail_menu_mobile.ggVPercentVisible
				) +
				me._thumbnail_menu_mobile.ggContentTopOffset +
				'px';
			me._thumbnail_menu_mobile.ggScrollPosYPercent =
				me._thumbnail_menu_mobile__vertScrollFg.offsetTop /
				me._thumbnail_menu_mobile__vertScrollBg.clientHeight;
		};
		me._thumbnail_menu_mobile.ggScrollByYSmooth = function (diffY) {
			...
			var id = setInterval(function () {
				...
				if (
					diffY < 0 &&
					(scrollCurrY <= diffY || me._thumbnail_menu_mobile.ggScrollPosY <= 0)
				) {
					me._thumbnail_menu_mobile.ggScrollPosY = Math.max(
						me._thumbnail_menu_mobile.ggScrollPosY,
						0
		...
		me._thumbnail_menu_mobile.ggScrollIntoView = function (posX, posY, width, height) {
			if (me._thumbnail_menu_mobile.ggHorScrollVisible) {
				if (posX < 0) {
					...
					posX + width >
					me._thumbnail_menu_mobile.clientWidth -
						(me._thumbnail_menu_mobile.ggVertScrollVisible ? 15 : 0)
				) {
					var diffX = Math.ceil(
						(posX +
							width -
			...
			if (me._thumbnail_menu_mobile.ggVertScrollVisible) {
				if (posY < 0) {
					...
					posY + height >
					me._thumbnail_menu_mobile.clientHeight -
						(me._thumbnail_menu_mobile.ggHorScrollVisible ? 15 : 0)
				) {
					var diffY = Math.ceil(
						(posY +
							height -
		...
		elVertScrollBg.setAttribute(
			'style',
			'position: absolute; right: 0px; top: 0px; visibility: hidden; width: 15px; height: 280px; background-color: rgba(255,255,255,0.392157); pointer-events: auto;'
		);
		...
		elVertScrollFg.setAttribute(
			'style',
			'position: absolute; left: 0px; top: 0px; visibility: hidden; width: 15px; height: 280px; background-color: rgba(255,255,255,1); pointer-events: auto;'
		);
		...
		me._thumbnail_menu_mobile.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('vis_userdata') == true) {
				newLogicStatePosition = 0;
			} else {
				newLogicStatePosition = -1;
			}
			if (me._thumbnail_menu_mobile.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._thumbnail_menu_mobile.style[domTransition] =
					'left 0s, top 0s, opacity 500ms ease 0ms, visibility 500ms ease 0ms';
		...
		me._thumbnail_menu_mobile.logicBlock_visible = function () {
			...
			if (me._thumbnail_menu_mobile.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._thumbnail_menu_mobile.ggCurrentLogicStateVisible == 0) {
					me._thumbnail_menu_mobile.style.visibility =
						Number(me._thumbnail_menu_mobile.style.opacity) > 0 ||
						!me._thumbnail_menu_mobile.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._thumbnail_menu_mobile.logicBlock_alpha = function () {
			...
			if (me._thumbnail_menu_mobile.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._thumbnail_menu_mobile.ggCurrentLogicStateAlpha == 0) {
					me._thumbnail_menu_mobile.style.visibility = me._thumbnail_menu_mobile.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me._thumbnail_menu_mobile.ggUpdatePosition = function (useTransition) {
			...
			}
			{
				...
				this.ggContent.style.marginTop = '0px';
				if (
					(me._thumbnail_menu_mobile.ggHorScrollVisible &&
						contentHeight > this.clientHeight - 15) ||
					(!me._thumbnail_menu_mobile.ggHorScrollVisible &&
				...
				if (me._thumbnail_menu_mobile.ggVertScrollVisible) {
					if (me._thumbnail_menu_mobile.ggHorScrollVisible) {
						me._thumbnail_menu_mobile.ggAvailableHeight =
							me._thumbnail_menu_mobile.clientHeight - 15;
					...
					me._thumbnail_menu_mobile__vertScrollBg.style.height =
						me._thumbnail_menu_mobile.ggAvailableHeight + 'px';
					me._thumbnail_menu_mobile.ggVPercentVisible =
						me._thumbnail_menu_mobile.ggAvailableHeight / contentHeight;
					if (me._thumbnail_menu_mobile.ggVPercentVisible > 1.0)
						me._thumbnail_menu_mobile.ggVPercentVisible = 1.0;
					me._thumbnail_menu_mobile.ggScrollHeight = Math.round(
						me._thumbnail_menu_mobile__vertScrollBg.clientHeight *
							me._thumbnail_menu_mobile.ggVPercentVisible
					);
					me._thumbnail_menu_mobile__vertScrollFg.style.height =
						me._thumbnail_menu_mobile.ggScrollHeight + 'px';
					me._thumbnail_menu_mobile.ggScrollPosY =
						me._thumbnail_menu_mobile.ggScrollPosYPercent *
						me._thumbnail_menu_mobile.ggAvailableHeight;
					me._thumbnail_menu_mobile.ggScrollPosY = Math.min(
		...
		me._thumbnail_cloner_mobile.callChildLogicBlocks_changenodeid = function () {
			if (me._thumbnail_cloner_mobile.ggInstances) {
				...
				for (i = 0; i < me._thumbnail_cloner_mobile.ggInstances.length; i++) {
					if (
						me._thumbnail_cloner_mobile.ggInstances[i]._checkmark_tick_mobile &&
						me._thumbnail_cloner_mobile.ggInstances[i]._checkmark_tick_mobile
							.logicBlock_visible
					) {
						me._thumbnail_cloner_mobile.ggInstances[
							i
						]._checkmark_tick_mobile.logicBlock_visible();
					}
					if (
						me._thumbnail_cloner_mobile.ggInstances[i]._thumbnail_title_mobile &&
						me._thumbnail_cloner_mobile.ggInstances[i]._thumbnail_title_mobile
							.logicBlock_alpha
					) {
						me._thumbnail_cloner_mobile.ggInstances[
							i
						]._thumbnail_title_mobile.logicBlock_alpha();
					}
				}
			}
		};
		me._thumbnail_cloner_mobile.callChildLogicBlocks_mouseover = function () {
			if (me._thumbnail_cloner_mobile.ggInstances) {
				...
				for (i = 0; i < me._thumbnail_cloner_mobile.ggInstances.length; i++) {
					if (
						me._thumbnail_cloner_mobile.ggInstances[i]._thumbnail_active_mobile &&
						me._thumbnail_cloner_mobile.ggInstances[i]._thumbnail_active_mobile
							.logicBlock_bordercolor
					) {
						me._thumbnail_cloner_mobile.ggInstances[
							i
						]._thumbnail_active_mobile.logicBlock_bordercolor();
					}
				}
			}
		};
		...
		el.ggUpdate = function (filter) {
			...
			if (parentWidth == 0)
				parentWidth = me._thumbnail_cloner_mobile.parentNode.parentNode.clientWidth;
			var numCols = Math.floor(
				(parentWidth * me._thumbnail_cloner_mobile.ggNumRepeat) /
					100.0 /
					me._thumbnail_cloner_mobile.offsetWidth
			);
			...
			for (var i = 0; i < tourNodes.length; i++) {
				...
				if (passed) {
					...
					var inst = new SkinCloner_thumbnail_cloner_mobile_Class(
						nodeId,
						me,
						el,
						parameter
		...
		me._thumbnail_cloner_mobile.ggUpdatePosition = function (useTransition) {
			...
			var h = player.getViewerSize().height;
			if (
				!me._thumbnail_cloner_mobile.ggLastSize ||
				me._thumbnail_cloner_mobile.ggLastSize.w != w ||
				me._thumbnail_cloner_mobile.ggLastSize.h != h
			) {
		...
		me._web_page.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_website') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._web_page.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._web_page.ggCurrentLogicStateVisible == 0) {
					me._web_page.style.visibility =
						Number(me._web_page.style.opacity) > 0 || !me._web_page.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._userdata.logicBlock_visible = function () {
			...
			if (me._userdata.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._userdata.ggCurrentLogicStateVisible == 0) {
					me._userdata.style.visibility =
						Number(me._userdata.style.opacity) > 0 || !me._userdata.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;userdata_close;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;userdata_close;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._information.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_info_popup') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._information.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._information.ggCurrentLogicStateVisible == 0) {
					me._information.style.visibility =
						Number(me._information.style.opacity) > 0 || !me._information.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_info_close;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_info_close;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._image_popup.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_image_popup') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._image_popup.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._image_popup.ggCurrentLogicStateVisible == 0) {
					me._image_popup.style.visibility =
						Number(me._image_popup.style.opacity) > 0 || !me._image_popup.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._popup_image.logicBlock_visible = function () {
			...
			if (me._popup_image.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._popup_image.ggCurrentLogicStateVisible == 0) {
					me._popup_image.style.visibility =
						Number(me._popup_image.style.opacity) > 0 || !me._popup_image.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._popup_image.ggUpdatePosition = function (useTransition) {
			...
			var aspectRatioImg =
				me._popup_image__img.naturalWidth / me._popup_image__img.naturalHeight;
			if (me._popup_image__img.naturalWidth < parentWidth)
				parentWidth = me._popup_image__img.naturalWidth;
			if (me._popup_image__img.naturalHeight < parentHeight)
				parentHeight = me._popup_image__img.naturalHeight;
			...
			if (aspectRatioDiv > aspectRatioImg) {
				...
				me._popup_image__img.setAttribute(
					'style',
					'position: absolute; left: 50%; margin-left: -' +
						...
						'px;height:' +
						parentHeight +
						'px;-webkit-user-drag:none;pointer-events:none;border-radius:0px;;'
				);
			} else {
		...
		me._video_popup_file.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_video_popup_file') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._video_popup_file.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._video_popup_file.ggCurrentLogicStateVisible == 0) {
					me._video_popup_file.style.visibility =
						Number(me._video_popup_file.style.opacity) > 0 ||
						!me._video_popup_file.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_video_file;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._popup_video_file.ggIsActive = function () {
			if (me._popup_video_file__vid != null) {
				return (
					me._popup_video_file__vid.paused == false &&
					me._popup_video_file__vid.ended == false
				);
			} else {
				return false;
			}
		...
		me._popup_video_file.logicBlock_visible = function () {
			...
			if (me._popup_video_file.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._popup_video_file.ggCurrentLogicStateVisible == 0) {
					me._popup_video_file.style.visibility =
						Number(me._popup_video_file.style.opacity) > 0 ||
						!me._popup_video_file.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._video_popup_controls_file.logicBlock_visible = function () {
			...
			if (me._video_popup_controls_file.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._video_popup_controls_file.ggCurrentLogicStateVisible == 0) {
					me._video_popup_controls_file.style.visibility =
						Number(me._video_popup_controls_file.style.opacity) > 0 ||
						!me._video_popup_controls_file.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._seekbar_file.connectToMediaEl = function () {
			...
			if (me._seekbar_file.mediaEl != null) {
				me._seekbar_file.mediaEl.removeEventListener(
					'progress',
				...
				if (me._seekbar_file.ggActivate) {
					me._seekbar_file.mediaEl.removeEventListener(
						'play',
						me._seekbar_file.ggActivate
					);
				}
				if (me._seekbar_file.ggDeactivate) {
					me._seekbar_file.mediaEl.removeEventListener(
						'ended',
						me._seekbar_file.ggDeactivate
					);
					me._seekbar_file.mediaEl.removeEventListener(
						'pause',
						me._seekbar_file.ggDeactivate
			...
			if (me._seekbar_file.mediaEl != null) {
				...
				me._seekbar_file.mediaEl.addEventListener(
					'progress',
					me._seekbar_file.updatePlayback
				);
				me._seekbar_file.mediaEl.addEventListener(
		...
		me._seekbar_file.updatePlayback = function () {
			...
			if (me._seekbar_file.mediaEl != null) {
				if (me._seekbar_file.mediaEl.readyState) {
					var percent =
						me._seekbar_file.mediaEl.currentTime / me._seekbar_file.mediaEl.duration;
					var playheadpos = Math.round(
						(me._seekbar_file.clientWidth - 2 * 8 + 1) * percent
					);
					playheadpos += 1;
					...
					var gradientString =
						'linear-gradient(90deg, #808080 0%, #808080 ' + currPos + '%';
					for (var i = 0; i < me._seekbar_file.mediaEl.buffered.length; i++) {
						var rangeStart = Math.round(
							(me._seekbar_file.mediaEl.buffered.start(i) /
								me._seekbar_file.mediaEl.duration) *
								100.0
						);
						var rangeEnd = Math.ceil(
							(me._seekbar_file.mediaEl.buffered.end(i) /
								me._seekbar_file.mediaEl.duration) *
								100.0
						);
						if (rangeEnd > currPos) {
							if (rangeStart < currPos) {
								...
								gradientString +=
									', #ffffff ' + currPos + '%, #ffffff ' + rangeStart + '%';
		...
		me._seekbar_file.ggIsActive = function () {
			if (me._seekbar_file.mediaEl != null) {
				return (
					me._seekbar_file.mediaEl.paused == false &&
					me._seekbar_file.mediaEl.ended == false
				);
			} else {
				return false;
			}
		...
		me._seekbar_file.onmousedown = function (e) {
			if (e.buttons == 1 || (e.buttons == null && e.which == 1) || e.type == 'touchend') {
				if (me._seekbar_file.mediaEl != null) {
					var eventXPos;
					if (e.type == 'touchend') eventXPos = e.layerX;
					else eventXPos = e.offsetX;
					var seekpos =
						(eventXPos / me._seekbar_file.clientWidth) *
						me._seekbar_file.mediaEl.duration;
		...
		me._seekbar_file.ggActivate = function () {
			...
			me._ht_video_pause_file.style.visibility =
				Number(me._ht_video_pause_file.style.opacity) > 0 ||
				!me._ht_video_pause_file.style.opacity
					? 'inherit'
					: 'hidden';
		...
		me._seekbar_file.ggDeactivate = function () {
			me._ht_video_play_file.style[domTransition] = 'none';
			me._ht_video_play_file.style.visibility =
				Number(me._ht_video_play_file.style.opacity) > 0 ||
				!me._ht_video_play_file.style.opacity
					? 'inherit'
					: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_play_file;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_play_file;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_pause_file;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_pause_file;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._video_popup_url.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_video_popup_url') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._video_popup_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._video_popup_url.ggCurrentLogicStateVisible == 0) {
					me._video_popup_url.style.visibility =
						Number(me._video_popup_url.style.opacity) > 0 ||
						!me._video_popup_url.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_video_url;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._popup_video_url.ggIsActive = function () {
			if (me._popup_video_url__vid != null) {
				return (
					me._popup_video_url__vid.paused == false &&
					me._popup_video_url__vid.ended == false
				);
			} else {
				return false;
			}
		...
		me._popup_video_url.logicBlock_visible = function () {
			...
			if (me._popup_video_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._popup_video_url.ggCurrentLogicStateVisible == 0) {
					me._popup_video_url.style.visibility =
						Number(me._popup_video_url.style.opacity) > 0 ||
						!me._popup_video_url.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._video_popup_controls_url.logicBlock_visible = function () {
			...
			if (me._video_popup_controls_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._video_popup_controls_url.ggCurrentLogicStateVisible == 0) {
					me._video_popup_controls_url.style.visibility =
						Number(me._video_popup_controls_url.style.opacity) > 0 ||
						!me._video_popup_controls_url.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._seekbar_url.connectToMediaEl = function () {
			...
			if (me._seekbar_url.mediaEl != null) {
				me._seekbar_url.mediaEl.removeEventListener(
					'progress',
			...
			if (me._seekbar_url.mediaEl != null) {
				...
				me._seekbar_url.mediaEl.addEventListener(
					'progress',
					me._seekbar_url.updatePlayback
				);
		...
		me._seekbar_url.updatePlayback = function () {
			...
			if (me._seekbar_url.mediaEl != null) {
				if (me._seekbar_url.mediaEl.readyState) {
					var percent =
						me._seekbar_url.mediaEl.currentTime / me._seekbar_url.mediaEl.duration;
					var playheadpos = Math.round(
						(me._seekbar_url.clientWidth - 2 * 8 + 1) * percent
					);
					playheadpos += 1;
					...
					for (var i = 0; i < me._seekbar_url.mediaEl.buffered.length; i++) {
						var rangeStart = Math.round(
							(me._seekbar_url.mediaEl.buffered.start(i) /
								me._seekbar_url.mediaEl.duration) *
								100.0
						);
						var rangeEnd = Math.ceil(
							(me._seekbar_url.mediaEl.buffered.end(i) /
								me._seekbar_url.mediaEl.duration) *
								100.0
						);
						if (rangeEnd > currPos) {
		...
		me._seekbar_url.ggIsActive = function () {
			if (me._seekbar_url.mediaEl != null) {
				return (
					me._seekbar_url.mediaEl.paused == false &&
					me._seekbar_url.mediaEl.ended == false
				);
			} else {
				return false;
			}
		...
		me._seekbar_url.onmousedown = function (e) {
			if (e.buttons == 1 || (e.buttons == null && e.which == 1) || e.type == 'touchend') {
				if (me._seekbar_url.mediaEl != null) {
					...
					var seekpos =
						(eventXPos / me._seekbar_url.clientWidth) *
						me._seekbar_url.mediaEl.duration;
		...
		me._seekbar_url.ggActivate = function () {
			...
			me._ht_video_pause_url.style.visibility =
				Number(me._ht_video_pause_url.style.opacity) > 0 ||
				!me._ht_video_pause_url.style.opacity
					? 'inherit'
					: 'hidden';
		...
		me._seekbar_url.ggDeactivate = function () {
			me._ht_video_play_url.style[domTransition] = 'none';
			me._ht_video_play_url.style.visibility =
				Number(me._ht_video_play_url.style.opacity) > 0 ||
				!me._ht_video_play_url.style.opacity
					? 'inherit'
					: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_play_url;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_play_url;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_pause_url;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_pause_url;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._video_popup_vimeo.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_video_popup_vimeo') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._video_popup_vimeo.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._video_popup_vimeo.ggCurrentLogicStateVisible == 0) {
					me._video_popup_vimeo.style.visibility =
						Number(me._video_popup_vimeo.style.opacity) > 0 ||
						!me._video_popup_vimeo.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_video_vimeo;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._popup_video_vimeo.logicBlock_visible = function () {
			...
			if (me._popup_video_vimeo.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._popup_video_vimeo.ggCurrentLogicStateVisible == 0) {
					me._popup_video_vimeo.style.visibility =
						Number(me._popup_video_vimeo.style.opacity) > 0 ||
						!me._popup_video_vimeo.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._video_popup_youtube.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('vis_video_popup_youtube') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._video_popup_youtube.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._video_popup_youtube.ggCurrentLogicStateVisible == 0) {
					me._video_popup_youtube.style.visibility =
						Number(me._video_popup_youtube.style.opacity) > 0 ||
						!me._video_popup_youtube.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;loading_video_youtube;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._popup_video_youtube.logicBlock_visible = function () {
			...
			if (me._popup_video_youtube.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._popup_video_youtube.ggCurrentLogicStateVisible == 0) {
					me._popup_video_youtube.style.visibility =
						Number(me._popup_video_youtube.style.opacity) > 0 ||
						!me._popup_video_youtube.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me.__360image_gyro.ggIsActive = function () {
			return (
				me.__360image_gyro.ggTimestamp + me.__360image_gyro.ggTimeout >= me.ggCurrentTime
			);
		};
		el.ggElementNodeId = function () {
			return player.getCurrentNode();
		...
		me.__360image_gyro.logicBlock_visible = function () {
			...
			if (me.__360image_gyro.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me.__360image_gyro.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me.__360image_gyro.ggCurrentLogicStateVisible == 0) {
					me.__360image_gyro.style.visibility =
						Number(me.__360image_gyro.style.opacity) > 0 ||
						!me.__360image_gyro.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me.__360image_gyro.logicBlock_alpha = function () {
			var newLogicStateAlpha;
			if (me.__360image_gyro.ggIsActive() == false) {
				newLogicStateAlpha = 0;
			} else {
				newLogicStateAlpha = -1;
			}
			if (me.__360image_gyro.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me.__360image_gyro.ggCurrentLogicStateAlpha == 0) {
					...
					me.__360image_gyro.style.visibility = me.__360image_gyro.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me.__360image_timer.ggIsActive = function () {
			return me.__360image_timer.ggTimestamp == 0
				? false
				: Math.floor(
						(me.ggCurrentTime - me.__360image_timer.ggTimestamp) /
							me.__360image_timer.ggTimeout
				  ) %
						2 ==
						0;
		};
		...
		me.__360image.logicBlock_position = function () {
			var newLogicStatePosition;
			if (player.getVariableValue('pos_360image') == 0) {
				newLogicStatePosition = 0;
			} else if (player.getVariableValue('pos_360image') == 1) {
				newLogicStatePosition = 1;
			} else if (player.getVariableValue('pos_360image') == 2) {
				newLogicStatePosition = 2;
			} else if (player.getVariableValue('pos_360image') == 3) {
				newLogicStatePosition = 3;
			} else if (player.getVariableValue('pos_360image') == 4) {
				newLogicStatePosition = 4;
			} else {
				newLogicStatePosition = -1;
			}
			if (me.__360image.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__360image.style[domTransition] =
					'left 1000ms ease 0ms, top 1000ms ease 0ms, ' +
					cssPrefix +
		...
		me.__360image.logicBlock_scaling = function () {
			...
			if (player.getVariableValue('pos_360image') == 2) {
				newLogicStateScaling = 0;
			} else if (player.getVariableValue('pos_360image') == 3) {
				newLogicStateScaling = 1;
			} else if (player.getVariableValue('pos_360image') == 4) {
				newLogicStateScaling = 2;
			} else if (player.getVariableValue('pos_360image') == 5) {
			...
			if (me.__360image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__360image.ggCurrentLogicStateScaling == 0) {
					...
					me.__360image.style[domTransform] = parameterToTransform(
						me.__360image.ggParameter
					);
		...
		me._phone2.logicBlock_scaling = function () {
			var newLogicStateScaling;
			if (player.getVariableValue('pos_360image') == 1) {
				newLogicStateScaling = 0;
			} else if (player.getVariableValue('pos_360image') == 2) {
				newLogicStateScaling = 1;
			} else if (player.getVariableValue('pos_360image') == 3) {
		...
		me._phone3.logicBlock_scaling = function () {
			...
			if (player.getVariableValue('pos_360image') == 1) {
				newLogicStateScaling = 0;
			} else if (player.getVariableValue('pos_360image') == 0) {
				newLogicStateScaling = 1;
			} else if (player.getVariableValue('pos_360image') == 0) {
				newLogicStateScaling = 2;
			} else {
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;close;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;close;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._close.logicBlock_visible = function () {
			...
			if (me._close.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._close.ggCurrentLogicStateVisible == 0) {
					me._close.style.visibility =
						Number(me._close.style.opacity) > 0 || !me._close.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._loading.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_loader') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._loading.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._loading.ggCurrentLogicStateVisible == 0) {
					me._loading.style.visibility =
						Number(me._loading.style.opacity) > 0 || !me._loading.style.opacity
							? 'inherit'
							: 'hidden';
		...
		el = me._loreal = document.createElement('div');
		els = me._loreal__img = document.createElement('img');
		els.className = 'ggskin ggskin_loreal';
		hs = basePath + 'data/migros/images/loreal.png';
		els.setAttribute('src', hs);
		els.ggNormalSrc = hs;
		els.setAttribute('alt', 'Loreal Logo');
		els.setAttribute(
			'style',
		...
		el.setAttribute('style', hs);
		el.style[domTransform + 'Origin'] = '50% 50%';
		me._loreal.ggIsActive = function () {
			return false;
		};
		el.ggElementNodeId = function () {
			return player.getCurrentNode();
		};
		me._loreal.ggUpdatePosition = function (useTransition) {};
		me.divSkin.appendChild(me._loreal);
		me._popup_video_file.ggVideoSource = 'media/';
		me._popup_video_file.ggVideoNotLoaded = true;
		...
		player.addListener('configloaded', function () {
			if (player.getVariableValue('opt_autohide') == true) {
				me._hide_timer.ggTimeout = Number('5') * 1000.0;
				me._hide_timer.ggTimestamp = skin.ggCurrentTime;
			}
			if (player.getVariableValue('opt_zoom') == true) {
			...
			if (player.getVariableValue('opt_zoom') == true && player.getOS() != 4) {
				player.setVariableValue(
					'pos_fullscreen',
					player.getVariableValue('pos_fullscreen') + Number('2')
				);
			}
			if (player.getVariableValue('opt_autorotate') == true && player.getOS() != 4) {
				player.setVariableValue(
					'pos_fullscreen',
					player.getVariableValue('pos_fullscreen') + Number('1')
				);
			}
			if (player.getVariableValue('opt_info') == true && player.getOS() != 4) {
				player.setVariableValue(
					'pos_fullscreen',
					player.getVariableValue('pos_fullscreen') + Number('1')
				);
			...
			if (player.getVariableValue('opt_projection') == true && player.getOS() != 4) {
				player.setVariableValue(
					'pos_fullscreen',
					player.getVariableValue('pos_fullscreen') + Number('1')
				);
			...
			if (player.getVariableValue('opt_zoom') == true && player.getIsMobile() == true) {
				player.setVariableValue(
					'pos_gyro',
					player.getVariableValue('pos_gyro') + Number('2')
				);
			}
			if (player.getVariableValue('opt_autorotate') == true && player.getIsMobile() == true) {
				player.setVariableValue(
					'pos_gyro',
					player.getVariableValue('pos_gyro') + Number('1')
				);
			}
			if (player.getVariableValue('opt_info') == true && player.getIsMobile() == true) {
				player.setVariableValue(
					'pos_gyro',
					player.getVariableValue('pos_gyro') + Number('1')
				);
			...
			if (player.getVariableValue('opt_projection') == true && player.getIsMobile() == true) {
				player.setVariableValue(
					'pos_gyro',
					player.getVariableValue('pos_gyro') + Number('1')
				);
		...
		player.addListener('beforechangenode', function () {
			if (player.getVariableValue('vis_loader') == true) {
				me._loading.style[domTransition] = 'none';
				me._loading.style.visibility =
					Number(me._loading.style.opacity) > 0 || !me._loading.style.opacity
						? 'inherit'
	...
	me.callChildLogicBlocksHotspot_ht_url_changenodeid = function () {
		if (hotspotTemplates['ht_url']) {
			...
			for (i = 0; i < hotspotTemplates['ht_url'].length; i++) {
				...
				if (
					hotspotTemplates['ht_url'][i]._ht_url_image &&
					hotspotTemplates['ht_url'][i]._ht_url_image.logicBlock_visible
				) {
					hotspotTemplates['ht_url'][i]._ht_url_image.logicBlock_visible();
				}
				if (
					hotspotTemplates['ht_url'][i]._ht_url_image_newpage &&
					hotspotTemplates['ht_url'][i]._ht_url_image_newpage.logicBlock_visible
				) {
					hotspotTemplates['ht_url'][i]._ht_url_image_newpage.logicBlock_visible();
				}
				if (
					hotspotTemplates['ht_url'][i]._tt_ht_url &&
	...
	me.callChildLogicBlocksHotspot_ht_info_changenodeid = function () {
		if (hotspotTemplates['ht_info']) {
			...
			for (i = 0; i < hotspotTemplates['ht_info'].length; i++) {
				...
				if (
					hotspotTemplates['ht_info'][i]._tt_information &&
	...
	me.callChildLogicBlocksHotspot_ht_image_changenodeid = function () {
		if (hotspotTemplates['ht_image']) {
			...
			for (i = 0; i < hotspotTemplates['ht_image'].length; i++) {
				...
				if (
					hotspotTemplates['ht_image'][i]._tt_ht_image &&
	...
	me.callChildLogicBlocksHotspot_ht_video_file_changenodeid = function () {
		if (hotspotTemplates['ht_video_file']) {
			...
			for (i = 0; i < hotspotTemplates['ht_video_file'].length; i++) {
				...
				if (
					hotspotTemplates['ht_video_file'][i]._tt_ht_video_file &&
	...
	me.callChildLogicBlocksHotspot_ht_video_url_changenodeid = function () {
		if (hotspotTemplates['ht_video_url']) {
			...
			for (i = 0; i < hotspotTemplates['ht_video_url'].length; i++) {
				...
				if (
					hotspotTemplates['ht_video_url'][i]._tt_ht_video_url &&
	...
	me.callChildLogicBlocksHotspot_ht_video_vimeo_changenodeid = function () {
		if (hotspotTemplates['ht_video_vimeo']) {
			...
			for (i = 0; i < hotspotTemplates['ht_video_vimeo'].length; i++) {
				...
				if (
					hotspotTemplates['ht_video_vimeo'][i]._tt_ht_video_vimeo &&
	...
	me.callChildLogicBlocksHotspot_ht_video_youtube_changenodeid = function () {
		if (hotspotTemplates['ht_video_youtube']) {
			...
			for (i = 0; i < hotspotTemplates['ht_video_youtube'].length; i++) {
				...
				if (
					hotspotTemplates['ht_video_youtube'][i]._tt_ht_video_youtube &&
					hotspotTemplates['ht_video_youtube'][i]._tt_ht_video_youtube.logicBlock_visible
				) {
					hotspotTemplates['ht_video_youtube'][
						i
					]._tt_ht_video_youtube.logicBlock_visible();
				}
			}
		}
	};
		...
		if (hotspotTemplates['ht_video_youtube']) {
			...
			for (i = 0; i < hotspotTemplates['ht_video_youtube'].length; i++) {
				if (
					...
					hotspotTemplates['ht_video_youtube'][
						i
					]._tt_ht_video_youtube.logicBlock_position();
				}
			}
		}
	};
			...
			if (hotspotTemplates['ht_video_youtube']) {
				...
				for (i = 0; i < hotspotTemplates['ht_video_youtube'].length; i++) {
					if (
						...
						hotspotTemplates['ht_video_youtube'][
							i
						]._ht_video_youtube.logicBlock_visible();
					}
				}
			}
		};
	...
	me.callChildLogicBlocksHotspot_ht_node_sizechanged = function () {
		if (hotspotTemplates['ht_node']) {
			...
			for (i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (
					hotspotTemplates['ht_node'][i]._hs_tt &&
	...
	me.callChildLogicBlocksHotspot_ht_node_changenodeid = function () {
		if (hotspotTemplates['ht_node']) {
			...
			for (i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				...
				if (
					hotspotTemplates['ht_node'][i]._tt_ht_3d &&
				...
				if (
					hotspotTemplates['ht_node'][i]._hs_visited &&
	...
	me.callChildLogicBlocksHotspot_ht_node_mouseover = function () {
		if (hotspotTemplates['ht_node']) {
			...
			for (i = 0; i < hotspotTemplates['ht_node'].length; i++) {
				if (
					hotspotTemplates['ht_node'][i]._chevron_white_lower &&
					hotspotTemplates['ht_node'][i]._chevron_white_lower.logicBlock_alpha
				) {
					hotspotTemplates['ht_node'][i]._chevron_white_lower.logicBlock_alpha();
				}
				if (
					hotspotTemplates['ht_node'][i]._chevron_black &&
					hotspotTemplates['ht_node'][i]._chevron_black.logicBlock_alpha
				) {
					hotspotTemplates['ht_node'][i]._chevron_black.logicBlock_alpha();
				}
				if (
					hotspotTemplates['ht_node'][i]._chevron_white &&
	...
	function SkinHotspotClass_ht_url(parentScope, hotspot) {
		...
		me._ht_url.logicBlock_visible = function () {
			...
			if (me._ht_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_url.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_url.style.visibility =
						Number(me._ht_url.style.opacity) > 0 || !me._ht_url.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_url_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_url_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._ht_url_image.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getIsMobile() == false && player.getVariableValue('opt_url') == true) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._ht_url_image.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_url_image.ggCurrentLogicStateVisible == 0) {
					me._ht_url_image.style.visibility =
						Number(me._ht_url_image.style.opacity) > 0 ||
						!me._ht_url_image.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._ht_url_image.onclick = function (e) {
			skin._web_page.ggText =
				'<iframe src="' +
				me.hotspot.url +
				'" width="100%" height="100%" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" frameborder= "0" ></iframe>';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_url_image_newpage;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_url_image_newpage;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._ht_url_image_newpage.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getIsMobile() == true || player.getVariableValue('opt_url') == false) {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._ht_url_image_newpage.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_url_image_newpage.ggCurrentLogicStateVisible == 0) {
					me._ht_url_image_newpage.style.visibility =
						Number(me._ht_url_image_newpage.style.opacity) > 0 ||
						!me._ht_url_image_newpage.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._tt_ht_url.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_url'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_ht_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_url.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_url.style.visibility =
						Number(me._tt_ht_url.style.opacity) > 0 || !me._tt_ht_url.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_info(parentScope, hotspot) {
		...
		me._ht_info.logicBlock_visible = function () {
			...
			if (me._ht_info.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_info.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_info.style.visibility =
						Number(me._ht_info.style.opacity) > 0 || !me._ht_info.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_info_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_info_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_information.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_info'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_information.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_information.ggCurrentLogicStateVisible == 0) {
					me._tt_information.style.visibility =
						Number(me._tt_information.style.opacity) > 0 ||
						!me._tt_information.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_image(parentScope, hotspot) {
		...
		me._ht_image.logicBlock_visible = function () {
			...
			if (me._ht_image.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_image.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_image.style.visibility =
						Number(me._ht_image.style.opacity) > 0 || !me._ht_image.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_image_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_image_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_ht_image.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_image'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_ht_image.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_image.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_image.style.visibility =
						Number(me._tt_ht_image.style.opacity) > 0 || !me._tt_ht_image.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_video_file(parentScope, hotspot) {
		...
		me._ht_video_file.logicBlock_visible = function () {
			...
			if (me._ht_video_file.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_video_file.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_video_file.style.visibility =
						Number(me._ht_video_file.style.opacity) > 0 ||
						!me._ht_video_file.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._ht_video_file.logicBlock_alpha = function () {
			...
			if (me._ht_video_file.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_video_file.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_file.style.visibility = me._ht_video_file.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_file_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_file_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_ht_video_file.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_video_file'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_ht_video_file.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_video_file.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_video_file.style.visibility =
						Number(me._tt_ht_video_file.style.opacity) > 0 ||
						!me._tt_ht_video_file.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_video_url(parentScope, hotspot) {
		...
		me._ht_video_url.logicBlock_visible = function () {
			...
			if (me._ht_video_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_video_url.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_video_url.style.visibility =
						Number(me._ht_video_url.style.opacity) > 0 ||
						!me._ht_video_url.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._ht_video_url.logicBlock_alpha = function () {
			...
			if (me._ht_video_url.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_video_url.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_url.style.visibility = me._ht_video_url.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_url_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_url_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_ht_video_url.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_video_url'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_ht_video_url.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_video_url.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_video_url.style.visibility =
						Number(me._tt_ht_video_url.style.opacity) > 0 ||
						!me._tt_ht_video_url.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_video_vimeo(parentScope, hotspot) {
		...
		me._ht_video_vimeo.logicBlock_visible = function () {
			...
			if (me._ht_video_vimeo.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_video_vimeo.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_video_vimeo.style.visibility =
						Number(me._ht_video_vimeo.style.opacity) > 0 ||
						!me._ht_video_vimeo.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._ht_video_vimeo.logicBlock_alpha = function () {
			...
			if (me._ht_video_vimeo.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_video_vimeo.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_vimeo.style.visibility = me._ht_video_vimeo.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_vimeo_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_vimeo_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_ht_video_vimeo.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_video_vimeo'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_ht_video_vimeo.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_video_vimeo.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_video_vimeo.style.visibility =
						Number(me._tt_ht_video_vimeo.style.opacity) > 0 ||
						!me._tt_ht_video_vimeo.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_video_youtube(parentScope, hotspot) {
		...
		me._ht_video_youtube.logicBlock_visible = function () {
			...
			if (me._ht_video_youtube.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._ht_video_youtube.ggCurrentLogicStateVisible == 0) {
					...
					me._ht_video_youtube.style.visibility =
						Number(me._ht_video_youtube.style.opacity) > 0 ||
						!me._ht_video_youtube.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._ht_video_youtube.logicBlock_alpha = function () {
			...
			if (me._ht_video_youtube.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._ht_video_youtube.ggCurrentLogicStateAlpha == 0) {
					me._ht_video_youtube.style.visibility = me._ht_video_youtube.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_video_youtube_image;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		elo.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_video_youtube_image;'
		);
		elo['ondragstart'] = function () {
			return false;
		};
		...
		me._tt_ht_video_youtube.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (me.elementMouseOver['ht_video_youtube'] == true && me.hotspot.title != '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._tt_ht_video_youtube.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_video_youtube.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_video_youtube.style.visibility =
						Number(me._tt_ht_video_youtube.style.opacity) > 0 ||
						!me._tt_ht_video_youtube.style.opacity
							? 'inherit'
							: 'hidden';
	...
	function SkinHotspotClass_ht_node(parentScope, hotspot) {
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;chevron_white_lower;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._chevron_white_lower.logicBlock_alpha = function () {
			var newLogicStateAlpha;
			if (me.elementMouseOver['ht_node'] == true) {
				newLogicStateAlpha = 0;
			} else {
				newLogicStateAlpha = -1;
			}
			if (me._chevron_white_lower.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._chevron_white_lower.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._chevron_white_lower.ggCurrentLogicStateAlpha == 0) {
					me._chevron_white_lower.style.visibility = me._chevron_white_lower.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;chevron_black;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._chevron_black.logicBlock_alpha = function () {
			...
			if (me._chevron_black.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._chevron_black.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._chevron_black.ggCurrentLogicStateAlpha == 0) {
					me._chevron_black.style.visibility = me._chevron_black.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;chevron_white;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._chevron_white.logicBlock_alpha = function () {
			...
			if (me._chevron_white.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._chevron_white.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._chevron_white.ggCurrentLogicStateAlpha == 0) {
					me._chevron_white.style.visibility = me._chevron_white.ggVisible
						? 'inherit'
						: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;hs_preview_image;'
		);
		els.className = 'ggskin ggskin_nodeimage';
		els['ondragstart'] = function () {
			return false;
		...
		hs += 'pointer-events:none;';
		hs +=
			'border-radius: 5px; overflow: hidden; box-shadow: 0px 0px 2px #000000; transform:translate3d(0px,0px,90px) rotateX(-90deg) scale(1.5); transform-style: preserve-3d; -webkit-backface-visibility: hidden; backface-visibility: hidden;';
		el.setAttribute('style', hs);
		el.style[domTransform + 'Origin'] = '50% 50%';
		...
		me._hs_preview_image.logicBlock_alpha = function () {
			...
			if (me._hs_preview_image.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._hs_preview_image.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._hs_preview_image.ggCurrentLogicStateAlpha == 0) {
					me._hs_preview_image.style.visibility = me._hs_preview_image.ggVisible
						? 'inherit'
						: 'hidden';
		...
		me._hs_tt.logicBlock_visible = function () {
			var newLogicStateVisible;
			if (player.getVariableValue('opt_3d_tooltip') == false && me.hotspot.title == '') {
				newLogicStateVisible = 0;
			} else {
				newLogicStateVisible = -1;
			}
			if (me._hs_tt.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._hs_tt.ggCurrentLogicStateVisible == 0) {
					...
					me._hs_tt.style.visibility =
						Number(me._hs_tt.style.opacity) > 0 || !me._hs_tt.style.opacity
							? 'inherit'
							: 'hidden';
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;hs_visited;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._hs_visited.logicBlock_visible = function () {
			...
			if (me._hs_visited.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._hs_visited.ggCurrentLogicStateVisible == 0) {
					me._hs_visited.style.visibility =
						Number(me._hs_visited.style.opacity) > 0 || !me._hs_visited.style.opacity
							? 'inherit'
							: 'hidden';
		...
		hs += 'pointer-events:none;';
		hs +=
			'transform:translate3d(0px,0px,40px) rotateX(-90deg); font-size: 15px; -webkit-backface-visibility: hidden; backface-visibility: hidden;';
		el.setAttribute('style', hs);
		el.style[domTransform + 'Origin'] = '50% 100%';
		hs = 'position:absolute;';
		hs += 'box-sizing: border-box;';
		...
		me._tt_ht_3d.logicBlock_visible = function () {
			...
			if (me._tt_ht_3d.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._tt_ht_3d.ggCurrentLogicStateVisible == 0) {
					me._tt_ht_3d.style.visibility =
						Number(me._tt_ht_3d.style.opacity) > 0 || !me._tt_ht_3d.style.opacity
							? 'inherit'
							: 'hidden';
	...
	me.addSkinHotspot = function (hotspot) {
		...
		} else if (hotspot.skinid == 'ht_video_youtube') {
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope, ggParent, parameter) {
		...
		me.__div.setAttribute(
			'style',
			'position: absolute;width: 96px; height: 62px; visibility: inherit; overflow: visible;'
		);
		...
		els.setAttribute(
			'src',
			basePath + 'data/migros/images/thumbnail_nodeimage_' + nodeId + '.jpg'
		);
		el.ggNodeId = nodeId;
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;thumbnail_nodeimage;'
		);
		els.className = 'ggskin ggskin_nodeimage';
		els['ondragstart'] = function () {
			return false;
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;checkmark_tick;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._checkmark_tick.logicBlock_visible = function () {
			...
			if (me._checkmark_tick.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._checkmark_tick.ggCurrentLogicStateVisible == 0) {
					me._checkmark_tick.style.visibility =
						Number(me._checkmark_tick.style.opacity) > 0 ||
						!me._checkmark_tick.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._thumbnail_active.logicBlock_bordercolor = function () {
			...
			if (me._thumbnail_active.ggIsActive() == true) {
				newLogicStateBorderColor = 0;
			} else if (me.elementMouseOver['thumbnail_active'] == true) {
		...
		me._thumbnail_title.logicBlock_alpha = function () {
			...
			if (me._thumbnail_title.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._thumbnail_title.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._thumbnail_title.ggCurrentLogicStateAlpha == 0) {
					me._thumbnail_title.style.visibility = me._thumbnail_title.ggVisible
						? 'inherit'
						: 'hidden';
	...
	function SkinCloner_thumbnail_cloner_mobile_Class(nodeId, parentScope, ggParent, parameter) {
		...
		els.className = 'ggskin ggskin_nodeimage';
		els.setAttribute('src', basePath + 'data/migros/images/thumbnail_nodeimage_' + nodeId + '.jpg');
		el.ggNodeId = nodeId;
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;thumbnail_nodeimage_mobile;'
		);
		els.className = 'ggskin ggskin_nodeimage';
		els['ondragstart'] = function () {
			return false;
		...
		els.setAttribute(
			'style',
			'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;checkmark_tick_mobile;'
		);
		els['ondragstart'] = function () {
			return false;
		};
		...
		me._checkmark_tick_mobile.logicBlock_visible = function () {
			...
			if (me._checkmark_tick_mobile.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				if (me._checkmark_tick_mobile.ggCurrentLogicStateVisible == 0) {
					me._checkmark_tick_mobile.style.visibility =
						Number(me._checkmark_tick_mobile.style.opacity) > 0 ||
						!me._checkmark_tick_mobile.style.opacity
							? 'inherit'
							: 'hidden';
		...
		me._thumbnail_active_mobile.logicBlock_bordercolor = function () {
			var newLogicStateBorderColor;
			if (me._thumbnail_active_mobile.ggIsActive() == true) {
				newLogicStateBorderColor = 0;
			} else if (me.elementMouseOver['thumbnail_active_mobile'] == true) {
				newLogicStateBorderColor = 1;
			} else {
				newLogicStateBorderColor = -1;
			}
			if (
				me._thumbnail_active_mobile.ggCurrentLogicStateBorderColor !=
				newLogicStateBorderColor
			) {
				me._thumbnail_active_mobile.ggCurrentLogicStateBorderColor =
					newLogicStateBorderColor;
		...
		me._thumbnail_title_mobile.logicBlock_alpha = function () {
			...
			if (me._thumbnail_title_mobile.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._thumbnail_title_mobile.style[domTransition] =
					'opacity 500ms ease 0ms, visibility 500ms ease 0ms';
				if (me._thumbnail_title_mobile.ggCurrentLogicStateAlpha == 0) {
					me._thumbnail_title_mobile.style.visibility = me._thumbnail_title_mobile
						.ggVisible
						? 'inherit'
						: 'hidden';
	...
	player.addListener('varchanged_opt_3d_preview', function (args) {
		me.callChildLogicBlocksHotspot_ht_node_varchanged_opt_3d_preview();
	});
